...
import { getUserDetail, revokeAccess } from "../services/AuthService";
import { useAuth } from "../context/AuthContext";
import type { UserDetail } from "../types/AuthType";
            ...
            <>
              ...
              <div className="flex flex-col gap-3">
                <div className="flex flex-col gap-1">
                  ...
                  <code className="text-sm bg-base-200 px-3 py-2 rounded-lg break-all">
                    {user.id}
                  </code>
                </div>
                <div className="flex flex-col gap-1">
